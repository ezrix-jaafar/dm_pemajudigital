...
//<input type="text" name="new_dns_id" value="1" style="display: none;">
...
//...
    ...
    echo '<input type="hidden" name="new_dns_id" value="1">'; //DNS Hidden Field
...
//...
    //echo $form->showDropdownBottom('');
        ...
        echo '<input type="hidden" name="new_ip_id" value="1">'; //IP Hidden Field
